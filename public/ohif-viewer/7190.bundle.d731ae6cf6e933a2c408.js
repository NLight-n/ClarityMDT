...
/* harmony default export */ const fetch = ((/* unused pure expression or super */ null && (adapter)));
...
/* harmony export */ });
/* harmony import */ var _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44835);
/* harmony import */ var _interface_types_float_types_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74112);


function bufferToTypedArray(wasmType, buffer) {
    let typedArray = null;
    switch (wasmType) {
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UInt8: {
            typedArray = new Uint8Array(buffer);
            break;
        }
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Int8: {
            typedArray = new Int8Array(buffer);
            break;
        }
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UInt16: {
            typedArray = new Uint16Array(buffer);
            break;
        }
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Int16: {
            typedArray = new Int16Array(buffer);
            break;
        }
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UInt32: {
            typedArray = new Uint32Array(buffer);
            break;
        }
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Int32: {
            typedArray = new Int32Array(buffer);
            break;
        }
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UInt64: {
        ...
        case _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Int64: {
        ...
        case _interface_types_float_types_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.Float32: {
            typedArray = new Float32Array(buffer);
            break;
        }
        case _interface_types_float_types_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.Float64: {
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16881);
/* harmony import */ var _buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47911);
/* harmony import */ var _interface_types_float_types_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74112);
/* harmony import */ var _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44835);
...
function getPipelineModuleOutputArray(emscriptenModule, outputIndex, subIndex, componentType) {
    ...
    const data = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(componentType, dataUint8.buffer);
    return data;
}
...
function runPipelineEmscripten(pipelineModule, args, outputs, inputs) {
    if (!(inputs == null) && inputs.length > 0) {
        inputs.forEach(function (input, index) {
            switch (input.type) {
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.TextStream:
                    {
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.JsonCompatible:
                    {
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.BinaryStream:
                    {
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.TextFile:
                    {
                        pipelineModule.fs_writeFile(input.data.path, input.data.data);
                        break;
                    }
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.BinaryFile:
                    {
                        pipelineModule.fs_writeFile(input.data.path, input.data.data);
                        break;
                    }
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Image:
                    {
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Mesh:
                    {
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.PolyData:
                    {
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Image:
                    {
                        ...
                        image.direction = getPipelineModuleOutputArray(pipelineModule, index, 1, _interface_types_float_types_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.Float64);
                ...
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.Mesh:
                    {
                        ...
                        if (mesh.numberOfPoints > 0) {
                            ...
                            mesh.points = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(mesh.meshType.pointComponentType, new ArrayBuffer(0));
                        }
                        if (mesh.numberOfCells > 0) {
                            mesh.cells = getPipelineModuleOutputArray(pipelineModule, index, 1, mesh.meshType.cellComponentType);
                        }
                        else {
                            mesh.cells = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(mesh.meshType.cellComponentType, new ArrayBuffer(0));
                        }
                        if (mesh.numberOfPointPixels > 0) {
                            ...
                            mesh.pointData = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(mesh.meshType.pointPixelComponentType, new ArrayBuffer(0));
                        }
                        if (mesh.numberOfCellPixels > 0) {
                            ...
                            mesh.cellData = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(mesh.meshType.cellPixelComponentType, new ArrayBuffer(0));
                        }
                        outputData = mesh;
                        break;
                    }
                case _interface_types_interface_types_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.PolyData:
                    {
                        ...
                        if (polyData.numberOfPoints > 0) {
                            polyData.points = getPipelineModuleOutputArray(pipelineModule, index, 0, _interface_types_float_types_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.Float32);
                        }
                        else {
                            polyData.points = new Float32Array();
                        }
                        if (polyData.verticesBufferSize > 0) {
                            polyData.vertices = getPipelineModuleOutputArray(pipelineModule, index, 1, _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.UInt32);
                        }
                        else {
                            polyData.vertices = new Uint32Array();
                        }
                        if (polyData.linesBufferSize > 0) {
                            polyData.lines = getPipelineModuleOutputArray(pipelineModule, index, 2, _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.UInt32);
                        }
                        else {
                            polyData.lines = new Uint32Array();
                        }
                        if (polyData.polygonsBufferSize > 0) {
                            polyData.polygons = getPipelineModuleOutputArray(pipelineModule, index, 3, _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.UInt32);
                        }
                        else {
                            polyData.polygons = new Uint32Array();
                        }
                        if (polyData.triangleStripsBufferSize > 0) {
                            polyData.triangleStrips = getPipelineModuleOutputArray(pipelineModule, index, 4, _interface_types_int_types_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.UInt32);
                        }
                        else {
                        ...
                        if (polyData.numberOfPointPixels > 0) {
                            ...
                            polyData.pointData = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(polyData.polyDataType.pointPixelComponentType, new ArrayBuffer(0));
                        }
                        if (polyData.numberOfCellPixels > 0) {
                            ...
                            polyData.cellData = (0,_buffer_to_typed_array_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(polyData.polyDataType.cellPixelComponentType, new ArrayBuffer(0));
                        }
                        outputData = polyData;
                        break;
                    }
