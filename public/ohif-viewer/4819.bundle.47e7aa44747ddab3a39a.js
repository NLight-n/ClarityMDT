"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([[4819,2591],{
...
function getViewportModule({
  ...
  return [{
    ...
    isReferenceViewable: cornerstone_src.utils.isReferenceViewable.bind(null, servicesManager)
  }];
}
...
function promptTrackNewStudy({
  ...
  return new Promise(async function (resolve, reject) {
    ...
    let promptResult = standardMode ? await _askTrackMeasurements(uiViewportDialogService, customizationService, viewportId) : promptTrackNewStudy_RESPONSE.SET_STUDY_AND_SERIES;
 ...
 */
class TrackedMeasurementsService extends src/* PubSubService */.Rc {
  constructor() {
    super(EVENTS);
    this._trackedSeries = [];
  }
...
/* harmony default export */ const TrackedMeasurementsService_TrackedMeasurementsService = ((/* unused pure expression or super */ null && (TrackedMeasurementsService)));
