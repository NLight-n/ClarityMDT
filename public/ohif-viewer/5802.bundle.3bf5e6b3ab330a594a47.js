"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([[5802],{
...
// EXTERNAL MODULE: ../../../extensions/dicom-microscopy/src/utils/dicomWebClient.ts
var dicomWebClient = __webpack_require__(70956);
...
function DicomMicroscopyViewport({
  ...
  const installOpenLayersRenderer = (0,react.useCallback)(async (container, displaySet) => {
    const loadViewer = async metadata => {
      ...
      const client = (0,dicomWebClient/* default */.A)({
        extensionManager,
        servicesManager
      });
