...
function startInterpolation(viewportData) {
    ...
    if (interpolationList.length) {
        ...
        (0,esm.triggerEvent)(esm.eventTarget, Events/* default */.A.ANNOTATION_INTERPOLATION_PROCESS_COMPLETED, eventDetails);
    }
}
...
function interpolatePoints(originalPoints, knotsIndexes) {
    ...
    const xInterpolator = (0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .interpolateBasis */ .Qm)(knotsIndexes.map((k) => originalPoints[k][0]));
    const yInterpolator = (0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .interpolateBasis */ .Qm)(knotsIndexes.map((k) => originalPoints[k][1]));
    if (isPoints3D(originalPoints)) {
        const zInterpolator = (0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .interpolateBasis */ .Qm)(knotsIndexes.map((k) => originalPoints[k][2]));
        return ((0,d3_array__WEBPACK_IMPORTED_MODULE_1__/* .zip */ .yU)((0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .quantize */ .yd)(xInterpolator, n), (0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .quantize */ .yd)(yInterpolator, n), (0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .quantize */ .yd)(zInterpolator, n)));
    }
    else {
        return ((0,d3_array__WEBPACK_IMPORTED_MODULE_1__/* .zip */ .yU)((0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .quantize */ .yd)(xInterpolator, n), (0,d3_interpolate__WEBPACK_IMPORTED_MODULE_0__/* .quantize */ .yd)(yInterpolator, n)));
    }
}
