...
function modeFactory() {
  return {
    ...
    onModeEnter: ({
      ...
      toolbarService.updateSection(toolbarService.sections.primary, ['MeasurementTools', 'Zoom', 'StackScroll', 'WindowLevelGroup', 'Pan', 'Layout', 'MPR', 'Crosshairs', 'MoreTools']);
      ...
      toolbarService.updateSection('MoreTools', ['Reset', 'rotate-right', 'flipHorizontal', 'ImageSliceSync', 'ReferenceLines', 'ImageOverlayViewer', 'Capture', 'invert', 'Probe', 'Cine', 'Angle', 'CobbAngle', 'Magnify', 'RectangleROI', 'CalibrationLine', 'TagBrowser', 'AdvancedMagnify', 'UltrasoundDirectionalTool', 'WindowLevelRegion']);
