...
function ViewportOrientationMarkers({
  ...
  const markers = (0,react.useMemo)(() => {
    ...
    const rowCosines = gl_matrix_esm/* vec3.sub */.eR.sub(gl_matrix_esm/* vec3.create */.eR.create(), p10, p00);
    const columnCosines = gl_matrix_esm/* vec3.sub */.eR.sub(gl_matrix_esm/* vec3.create */.eR.create(), p01, p00);
    gl_matrix_esm/* vec3.normalize */.eR.normalize(rowCosines, rowCosines);
    gl_matrix_esm/* vec3.normalize */.eR.normalize(columnCosines, columnCosines);
